  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-slate-50">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <div className="mb-4">
          <label htmlFor="fullName" className="block text-sm font-medium mb-2 text-slate-700">Full Name</label>
          <input
            id="fullName"
            name="fullName"
            type="text"
        ...
        >
          {isSigningUp ? (<><Loader2 className="animate-spin h-5 w-5 mr-2 inline-block" /> Signing Up...</>) : 'Sign Up'}
        </button>
